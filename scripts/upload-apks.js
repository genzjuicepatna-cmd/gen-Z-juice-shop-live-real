...
async function main() {
  ...
  const apks = [
    { localPath: 'artifacts/android/TrendingJuicePOS-release.apk', storagePath: 'TrendingJuicePOS-release.apk' },
    { localPath: 'artifacts/android/TrendingJuiceCustomer-release.apk', storagePath: 'TrendingJuiceCustomer-release.apk' }
  ];
