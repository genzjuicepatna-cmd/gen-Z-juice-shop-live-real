      ...
      <div class="pos-layout">
        ...
        <div class="mobile-cart-toggle-bar" id="mobile-cart-toggle">
          <div style="display: flex; align-items: center; gap: 8px;">
            <span aria-hidden="true" class="material-symbols-rounded" style="color: var(--color-primary-on-surface); font-size: 22px;">shopping_cart</span>
            <div>
          ...
          <button class="btn btn-primary btn-sm" id="btn-mobile-view-cart" style="padding: 8px 16px; font-weight: 700; font-size: 12px; display: flex; align-items: center; gap: 4px;">
            View Cart
            <span aria-hidden="true" class="material-symbols-rounded" style="font-size: 16px;">arrow_forward</span>
          </button>
        </div>
      </div>
    `;
