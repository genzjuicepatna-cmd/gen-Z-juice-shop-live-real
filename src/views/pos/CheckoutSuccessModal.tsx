...
export class CheckoutSuccessModal {
  ...
  async renderModal() {
    ...
    const restName = await getSetting('restaurantName') || BRAND.name;
    const restTag = await getSetting('restaurantTagline') || BRAND.tagline;
      ...
      <div class="modal" tabindex="-1" role="dialog" style="max-width: 440px;">
        <div class="modal-header">
          <h3 class="txt-primary txt-bold flex-row-between" style="gap: 10px; margin: 0;">
            <span aria-hidden="true" class="material-symbols-rounded txt-success" style="font-size: 24px; filter: drop-shadow(0 0 6px rgba(var(--color-success-rgb),0.3));">check_circle</span>
          ...
          <div class="whatsapp-share-card">
            ...
            <div style="display: flex; gap: 8px;">
              ...
              <button class="btn btn-whatsapp" id="btn-success-whatsapp" style="padding: 0 16px; min-height: 44px; display: flex; align-items: center; gap: 6px;">
                <span aria-hidden="true" class="material-symbols-rounded" style="font-size: 18px;">chat</span>
                Send VPA Bill
              </button>
            </div>
          </div>
        ...
        <div class="modal-footer" style="flex-direction: column; align-items: stretch; gap: 12px;">
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
            <button class="btn btn-secondary" id="btn-success-thermal-print">
              <span aria-hidden="true" class="material-symbols-rounded txt-brand" style="font-size: 18px;">print</span>
              Print (Thermal)
            </button>
            <button class="btn btn-secondary" id="btn-success-browser-print">
              <span aria-hidden="true" class="material-symbols-rounded" style="font-size: 18px; color:#60A5FA;">print</span>
              Standard (A4)
            </button>
          </div>
  ...
  async browserPrint() {
    ...
    try {
      ...
      printWindow.document.write(`
        <html>
          <body style="font-family: system-ui; text-align: center; padding: 40px; color: var(--color-danger-on-surface);">
