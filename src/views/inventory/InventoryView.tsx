      ...
      <div class="main-area">
        <div class="header-bar">
          ...
          <button id="add-inventory-btn" class="btn btn-primary btn-sm">
            <span aria-hidden="true" class="material-symbols-rounded" style="font-size:16px;">add</span> Add Item
          </button>
        </div>
      ...
      <div id="inv-modal" class="modal-overlay" style="display:none;">
        <div class="modal" style="max-width:400px;">
          <div class="modal-header">
            ...
            <button class="btn-icon" id="inv-close-icon"><span aria-hidden="true" class="material-symbols-rounded">close</span></button>
          </div>
  ...
  async loadData() {
    ...
    if (this.tab === 'stock') {
      ...
      content.innerHTML = items.length === 0 ?
        '<div class="empty-state"><span aria-hidden="true" class="material-symbols-rounded">inventory_2</span><p>No inventory items yet. Add items to track stock.</p></div>' :
      ...
      content.innerHTML = suppliers.length === 0 ?
        '<div class="empty-state"><span aria-hidden="true" class="material-symbols-rounded">local_shipping</span><p>No suppliers yet.</p></div>' :
