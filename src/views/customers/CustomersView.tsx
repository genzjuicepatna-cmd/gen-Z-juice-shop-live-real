      ...
      <div class="main-area">
        <div class="header-bar">
          <div class="header-bar-title">
            <span aria-hidden="true" class="material-symbols-rounded">loyalty</span>
            <h2>Customer CRM</h2>
          </div>
          <div style="display:flex;gap:12px;align-items:center;flex-wrap:wrap;flex:1;justify-content:flex-end;">
            ...
            <button id="add-customer-btn" class="btn btn-primary btn-sm" style="flex-shrink:0;">
              <span aria-hidden="true" class="material-symbols-rounded" style="font-size:16px;">person_add</span> Add
            </button>
          </div>
        </div>
      ...
      <div id="customer-modal" class="modal-overlay" style="display:none;">
        <div class="modal" style="max-width:400px;">
          <div class="modal-header">
            <h3>Add Customer</h3>
            <button class="btn-icon" id="cust-close-icon"><span aria-hidden="true" class="material-symbols-rounded">close</span></button>
          </div>
  ...
  async loadCustomers() {
    ...
    if (kpis) {
      kpis.innerHTML = [
        ...
        { label: 'AVG POINTS', value: avgPoints, color: 'var(--nextgenos-purple-on-surface)' },
    ...
    if (customers.length === 0) {
      list.innerHTML = `<div class="empty-state">
        <span aria-hidden="true" class="material-symbols-rounded">person_off</span>
