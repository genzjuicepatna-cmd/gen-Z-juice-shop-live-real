...
export function LoyaltyDrawer({ loggedInCustomer, customerPhone, customerName, onClose, onShowLogin, onProfileLoaded }) {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      showToast(`Welcome to ${BRAND.rewardsName}!`, 'success');
      ...
      <div className="aether-drawer-sheet crm-drawer">
        ...
        <div className="aether-drawer-scroll-content">
          <div className="crm-hero-section">
            <span aria-hidden="true" className="material-symbols-rounded crm-hero-icon" style={{ color: 'var(--color-primary)', fontSize: '2.5rem', filter: 'drop-shadow(0 2px 8px var(--color-primary-glow))' }}>rewarded_ads</span>
            <h2>{BRAND.rewardsName}</h2>
          ...
          <div className="crm-body-content">
            ...
            {view === 'register' && (
              <div className="crm-register-view" style={{ textAlign: 'center', padding: '16px 8px' }}>
                <span aria-hidden="true" className="material-symbols-rounded" style={{ fontSize: '48px', color: 'var(--color-primary)', marginBottom: '8px' }}>app_registration</span>
                <h3>Join the {BRAND.rewardsName}</h3>
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.75rem', marginBottom: '18px' }}>You don't have a rewards profile yet. Register your details to start earning points on every cup!</p>
            ...
            {view === 'link_phone' && (
              <div className="crm-register-view" style={{ textAlign: 'center', padding: '16px 8px' }}>
                <span aria-hidden="true" className="material-symbols-rounded" style={{ fontSize: '48px', color: 'var(--color-primary)', marginBottom: '8px' }}>phone_android</span>
                <h3>Link Phone Number</h3>
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.75rem', marginBottom: '18px' }}>To track your orders and collect points, please link your 10-digit mobile number.</p>
              ...
              <div className="crm-profile-view">
                <div className="crm-loyalty-card" style={{ background: tierGradients[customer.tier?.toLowerCase() || 'bronze'] }}>
                  <div className="crm-card-top">
                    <div className="crm-brand-name">{BRAND.name}</div>
                      ...
                      orders.map(order => {
                        ...
                        return (
                          <div key={order.id} className="crm-order-card">
                            ...
                            >
                              <span aria-hidden="true" className="material-symbols-rounded" style={{ fontSize: '12px', verticalAlign: 'middle', marginRight: '2px' }}>replay</span>
                              1-Click Reorder
                            </button>
                          </div>
                        );
