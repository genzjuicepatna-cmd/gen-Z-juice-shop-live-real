          ...
          <div class="login-brand-panel">
            <div class="login-brand-content">
              <div class="login-brand-logo-wrapper">
                <img src="/assets/store-logo.svg" class="brand-panel-logo" alt="${BRAND.name} logo" />
              </div>
              <h2 class="brand-panel-title">${BRAND.name}</h2>
              <p class="brand-panel-tagline">${BRAND.tagline}</p>
              
              <div class="brand-features-list">
                <div class="brand-feature-item">
                  <span aria-hidden="true" class="material-symbols-rounded feature-icon">star</span>
                ...
                <div class="brand-feature-item">
                  <span aria-hidden="true" class="material-symbols-rounded feature-icon">shopping_bag</span>
                  <div class="feature-text">
                    <h4 class="feature-title">Skip the Queue</h4>
                    <p class="feature-desc">Order ahead for pickup or dine-in, and have it ready when you arrive.</p>
                  </div>
                </div>
                <div class="brand-feature-item">
                  <span aria-hidden="true" class="material-symbols-rounded feature-icon">qr_code_2</span>
                  <div class="feature-text">
                    <h4 class="feature-title">Dine-In QR Ordering</h4>
                    <p class="feature-desc">Scan any table QR code, pick your drinks, and order straight from your browser.</p>
                  </div>
                </div>
                <div class="brand-feature-item">
                  <span aria-hidden="true" class="material-symbols-rounded feature-icon">payments</span>
                  <div class="feature-text">
            ...
            <div class="login-card">
              ...
              <div class="login-home-btn-container">
                <button id="login-home-btn" class="btn btn-secondary btn-sm home-nav-btn">
                  <span aria-hidden="true" class="material-symbols-rounded" style="font-size: 16px;">home</span>
                  Home
                </button>
              </div>
              ...
              <div class="login-header-mobile">
                <div class="login-logo-container" id="login-logo-btn">
                  <img src="/assets/store-logo.svg" class="login-logo-img" alt="${BRAND.name} logo" />
                </div>
                <h1 class="login-title" id="login-brand-title">${BRAND.name}</h1>
                <p class="login-subtitle">${BRAND.tagline}</p>
              </div>
              
              <div style="margin-bottom: 20px; text-align: center;">
                <h2 style="font-family: var(--font-display); font-size: var(--text-md); font-weight: 700; color: var(--text-primary); margin-bottom: 4px; letter-spacing: -0.01em;">Welcome to the ${BRAND.rewardsName}</h2>
              ...
              <div class="login-section" id="section-cloud" style="display: block;">
                <div class="login-input-group">
                  ...
                  <div class="input-with-icon">
                    <span aria-hidden="true" class="material-symbols-rounded input-icon">mail</span>
                ...
                <div class="login-input-group">
                  ...
                  <div class="input-with-icon">
                    <span aria-hidden="true" class="material-symbols-rounded input-icon">lock</span>
                ...
                <p class="login-toggle-link" id="link-goto-signup">New to ${BRAND.name}? Register Account</p>
              </div>
              ...
              <div class="login-section" id="section-signup" style="display: none;">
                <div class="login-input-group">
                  ...
                  <div class="input-with-icon">
                    <span aria-hidden="true" class="material-symbols-rounded input-icon">person</span>
  ...
  async attemptCloudLogin() {
    ...
    try {
      ...
      if (staff) {
        ...
        showToast(`Welcome to ${BRAND.name}, ${staff.name}!`, 'success');
        this.destroy();
  ...
  async attemptSignup() {
    ...
    try {
      ...
      if (staff) {
        ...
        showToast(`Registration successful! Welcome to ${BRAND.name}, ${name}!`, 'success');
        this.destroy();
        if (this.onLoginSuccess) this.onLoginSuccess(staff);
      } else {
