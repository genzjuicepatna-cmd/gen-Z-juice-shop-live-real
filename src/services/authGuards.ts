...
export function membershipToStaffAccess(membership, storeId = STORE_ID) {
...
export function appMetadataToStaffAccess(user, storeId = STORE_ID) {
...
export function requireCloudStaffAccess(user, membership, storeId = STORE_ID) {
