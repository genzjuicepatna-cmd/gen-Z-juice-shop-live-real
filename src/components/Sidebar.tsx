  ...
  render(container) {
    ...
    container.innerHTML = `
      <div class="sidebar-header">
        <img src="/assets/store-logo.svg" class="sidebar-logo-img" alt="Logo" style="width:28px;height:28px;border-radius:6px;object-fit:contain;margin-right:2px;border:1px solid var(--border-active);box-shadow:var(--shadow-glow-active);" />
      ...
      <div class="sidebar-footer">
        <button class="sidebar-theme-toggle" id="sidebar-theme-btn" title="Toggle Theme">
          <span aria-hidden="true" class="material-symbols-rounded" id="sidebar-theme-icon" style="font-size: 16px;">${this._getThemeIcon()}</span>
