      ...
      <div class="modal" tabindex="-1" role="dialog" aria-label="Payment" style="max-width: 460px;">
        <div class="modal-header">
          <h3 class="txt-primary txt-bold flex-row-between" style="gap: 8px; margin: 0;">
            <span aria-hidden="true" class="material-symbols-rounded txt-brand" style="font-size: 24px; filter: drop-shadow(0 0 8px rgba(var(--color-primary-rgb), 0.4));">payments</span>
            Secure Checkout
          </h3>
          ...
          <div id="payment-upi-view" style="${this.selectedMethod !== 'upi' ? 'display:none;' : ''}">
            ...
            <div class="payment-qr-card">
              ...
              <div class="txt-muted txt-medium" style="font-size: var(--text-xs); display: flex; align-items: center; gap: 4px;">
                <span aria-hidden="true" class="material-symbols-rounded" style="font-size: 16px;">qr_code_scanner</span>
            ...
            <a href="#" id="upi-deeplink" target="_blank" rel="noopener noreferrer" class="btn btn-secondary btn-block btn-lg" style="margin-top: 14px; text-decoration: none;">
              <span aria-hidden="true" class="material-symbols-rounded" style="font-size: 18px;">open_in_new</span>
              Open in UPI App
            </a>
          </div>
        ...
        <div class="modal-footer">
          <button class="btn btn-primary btn-block btn-lg" id="btn-confirm-payment" ${this.isProcessing ? 'disabled' : ''}>
            <span aria-hidden="true" class="material-symbols-rounded" style="font-size: 20px;">check_circle</span>
      ...
      if (canvas.parentElement) {
        canvas.parentElement.innerHTML = `
          <div style="padding: 20px; text-align: center; color: var(--text-muted);">
            <span aria-hidden="true" class="material-symbols-rounded" style="font-size: 40px; display: block; margin-bottom: 8px;">qr_code</span>
